...
export default function JoyRideHomePage() {
  ...
  const handleServiceSelect = (serviceType: string) => {
    // Bạn có thể tùy chỉnh route tại đây, ví dụ: "/services" hoặc `/booking?type=${serviceType}`
    ...
    <div className="bg-[#FFFDF0] text-stone-800 relative">
      ...
      <section className="relative px-6 py-20 max-w-6xl mx-auto text-center space-y-8">
        <div className="absolute inset-0 z-10 opacity-20">
          <img
            src="/images/your-hero-image.png" // Đường dẫn này tính từ thư mục public/
            alt=""
        ...
        <button
          ...
          className="bg-[#FBBFDC] hover:bg-[#F9A8CB] text-stone-700 font-bold py-4 px-10 rounded-2xl shadow-lg transition-transform hover:-translate-y-1"
        >
          🌸 ĐẶT LỊCH HẸN NGAY
        </button>
